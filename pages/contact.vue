    ...
    <div class="preloader">
      <div class="preloader-content">
        <div class="preloader-logo">
          <span class="preloader-logo__letter">T</span>
          <span class="preloader-logo__letter">H</span>
          <span class="preloader-logo__letter">O</span>
          <span class="preloader-logo__letter">S</span>
          <span class="preloader-logo__letter">U</span>
          <span class="preloader-logo__letter">A</span>
          <span class="preloader-logo__letter">B</span>
          <span class="preloader-logo__letter">E</span>
          <span class="preloader-logo__letter">P</span>
          <span class="preloader-logo__letter"></span>
          <span class="preloader-logo__letter red">.</span>
          <span class="preloader-logo__letter red">C</span>
          <span class="preloader-logo__letter red">O</span>
          <span class="preloader-logo__letter red">M</span>
        </div>
      </div>
    </div>
    <!--  -->
...
.profile {
  background-image: url(../static/assets/images/meo-meo.jpg);
